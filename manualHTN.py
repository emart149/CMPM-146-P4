...
pyhop.declare_operators(op_punch_for_wood, op_craft_plank, op_craft_stick ,op_craft_bench, op_craft_wooden_axe_at_bench, op_wooden_axe_for_wood)
...
2 wood = -8 time
8 planks = -2 time
4 sticks = -1 time and -2 planks

state: 6 planks and 4 sticks and -11 time

bench = -1 time and -4 planks

state: bench, 2 planks, 4 sticks -12 time

1 wood = -4 time
4 planks = -1 time
wood axe = -1 time and -3 planks and -2 sticks 

state: bench, 3 planks, 2 sticks and -18 time

12 wood with wooden axe = -24 time and +12 wood
"""